...
/**
 * This is the item provider adapter for a {@link model.HoldsAt} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HoldsAtItemProvider 
	 ...
	 * @generated
	 */
	public HoldsAtItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HoldsAt_time_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HoldsAt_time_feature", "_UI_HoldsAt_type"),
				 ModelPackage.Literals.HOLDS_AT__TIME,
				 true,
				 false,
				 false,
	...
	protected void addIsHoldingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HoldsAt_isHolding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HoldsAt_isHolding_feature", "_UI_HoldsAt_type"),
				 ModelPackage.Literals.HOLDS_AT__IS_HOLDING,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HoldsAt"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HoldsAt.class)) {
