...
public class InitiallyItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.INITIALLY__CONTEXT_RELATION);
			childrenFeatures.add(ModelPackage.Literals.INITIALLY__INSTANCES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Initially.class)) {
