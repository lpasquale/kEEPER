package event.model.diagram.parsers;
 ...
 * @generated
 */
public class GeneralTypeReferenceLabelExpressionLabelParser implements IParser {
	/**
	* @generated
	*/
	public GeneralTypeReferenceLabelExpressionLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		if (((GeneralTypeReference) self).getReference() != null) {
			return ((GeneralTypeReference) self).getReference().getName();
		} else
			return null;
	}
