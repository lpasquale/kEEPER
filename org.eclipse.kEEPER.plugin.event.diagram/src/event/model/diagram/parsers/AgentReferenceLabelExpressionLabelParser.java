 ...
 * @generated
 */
public class AgentReferenceLabelExpressionLabelParser implements IParser {
	/**
	* @generated
	*/
	public AgentReferenceLabelExpressionLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		if (((AgentReference) self).getReference() != null) {
			return ((AgentReference) self).getReference().getName();
		} else
			return null;
	}
