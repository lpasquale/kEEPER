 ...
 * @generated
 */
public class ObserverReferenceLabelExpressionLabelParser implements IParser {
	/**
	* @generated
	*/
	public ObserverReferenceLabelExpressionLabelParser() {
	}
	...
	*/
	private String evaluatePrintExpression(EObject self) {
		if (((ObserverReference) self).getReference() != null) {
			return ((ObserverReference) self).getReference().getName();
		} else
			return null;
	}
