...
import event.model.diagram.edit.policies.ModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ObserverReferenceTypeNameEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(ModelVisualIDRegistry
				.getType(event.model.diagram.edit.parts.ObserverReferenceTypeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ObserverReferenceTypeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.ObserverReference_2017, getParserElement(),
					ModelVisualIDRegistry
							.getType(event.model.diagram.edit.parts.ObserverReferenceTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ObserverNameFigure();
	}

	/**
	 * @generated
	 */
	public class ObserverNameFigure extends WrappingLabel {
