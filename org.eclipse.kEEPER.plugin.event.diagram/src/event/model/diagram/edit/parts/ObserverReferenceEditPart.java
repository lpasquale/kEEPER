...
import event.model.diagram.edit.policies.ObserverReferenceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ObserverReferenceEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public ObserverReferenceEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ObserverReferenceItemSemanticEditPolicy());
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ObserverReferenceTypeNameEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ModelVisualIDRegistry.getType(ObserverReferenceTypeNameEditPart.VISUAL_ID));
	}
