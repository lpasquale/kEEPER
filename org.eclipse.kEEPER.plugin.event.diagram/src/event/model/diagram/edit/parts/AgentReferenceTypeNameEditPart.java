 ...
 * @generated
 */
public class AgentReferenceTypeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry.getType(event.model.diagram.edit.parts.AgentReferenceTypeNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public AgentReferenceTypeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.AgentReference_2016, getParserElement(),
					ModelVisualIDRegistry
							.getType(event.model.diagram.edit.parts.AgentReferenceTypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgentNameFigure();
	}

	/**
	 * @generated
	 */
	public class AgentNameFigure extends WrappingLabel {
