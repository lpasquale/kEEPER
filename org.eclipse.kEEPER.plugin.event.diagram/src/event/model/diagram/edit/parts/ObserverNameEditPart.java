 ...
 * @generated
 */
public class ObserverNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry.getType(event.model.diagram.edit.parts.ObserverNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ObserverNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Observer_2014, getParserElement(),
					ModelVisualIDRegistry.getType(event.model.diagram.edit.parts.ObserverNameEditPart.VISUAL_ID));
		}
		return parser;
	}
