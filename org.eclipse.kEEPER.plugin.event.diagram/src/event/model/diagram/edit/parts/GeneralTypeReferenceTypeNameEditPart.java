 ...
 * @generated
 */
public class GeneralTypeReferenceTypeNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(event.model.diagram.edit.parts.GeneralTypeReferenceTypeNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public GeneralTypeReferenceTypeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.GeneralTypeReference_2018, getParserElement(),
					ModelVisualIDRegistry
							.getType(event.model.diagram.edit.parts.GeneralTypeReferenceTypeNameEditPart.VISUAL_ID));
		}
		return parser;
