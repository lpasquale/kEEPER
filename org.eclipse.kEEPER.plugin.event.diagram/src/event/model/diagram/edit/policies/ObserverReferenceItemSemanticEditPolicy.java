 ...
 * @generated
 */
public class ObserverReferenceItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ObserverReferenceItemSemanticEditPolicy() {
		super(ModelElementTypes.ObserverReference_2017);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == PrimitiveEventObserverEditPart.VISUAL_ID) {
