 ...
 * @generated
 */
public class AgentReferenceItemSemanticEditPolicy extends ModelBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public AgentReferenceItemSemanticEditPolicy() {
		super(ModelElementTypes.AgentReference_2016);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == PrimitiveEventAgentEditPart.VISUAL_ID) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == ComplexEventAgentEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
