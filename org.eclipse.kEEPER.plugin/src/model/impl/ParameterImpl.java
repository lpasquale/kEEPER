...
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	public Instance getInstance() {
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.PARAMETER__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(Instance newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAMETER__INSTANCE, oldInstance, instance));
	}
