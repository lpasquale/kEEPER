 ...
 *   <li>{@link model.impl.AgentReferenceImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgentReferenceImpl extends MinimalEObjectImpl.Container implements AgentReference {
	...
	public void setTypeName(String newTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AGENT_REFERENCE__TYPE_NAME, oldTypeName, typeName));
	}
