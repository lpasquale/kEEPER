 ...
 * @generated
 */
public class InitiallyInstancesNameCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ModelPackage.eINSTANCE.getInitially_Instances();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getInitiallyInstancesNameCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return InstanceEditPart.VISUAL_ID == ModelVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getInitiallyInstancesNameCompartment_7002SemanticChildren((View) getHost().getModel());
