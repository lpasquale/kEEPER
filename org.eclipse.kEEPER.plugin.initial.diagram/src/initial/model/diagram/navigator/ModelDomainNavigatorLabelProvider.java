...
public class ModelDomainNavigatorLabelProvider implements ICommonLabelProvider {
	...
	*/
	public Image getImage(Object element) {
		if (element instanceof ModelDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider.getImage(((ModelDomainNavigatorItem) element).getEObject());
		}
		return null;
	}
	...
	*/
	public String getText(Object element) {
		if (element instanceof ModelDomainNavigatorItem) {
			return myAdapterFactoryLabelProvider.getText(((ModelDomainNavigatorItem) element).getEObject());
		}
		return null;
	}
