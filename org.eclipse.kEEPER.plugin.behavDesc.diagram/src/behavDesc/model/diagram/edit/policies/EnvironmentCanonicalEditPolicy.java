...
public class EnvironmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<behavDesc.model.diagram.part.ModelNodeDescriptor> childDescriptors = behavDesc.model.diagram.part.ModelDiagramUpdater
				.getEnvironment_1000SemanticChildren(viewObject);
		for (behavDesc.model.diagram.part.ModelNodeDescriptor d : childDescriptors) {
	...
	*/
	protected void refreshSemantic() {
		...
		for (Iterator<behavDesc.model.diagram.part.ModelNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			behavDesc.model.diagram.part.ModelNodeDescriptor next = descriptorsIterator.next();
			String hint = behavDesc.model.diagram.part.ModelVisualIDRegistry.getType(next.getVisualID());
		...
		for (behavDesc.model.diagram.part.ModelNodeDescriptor next : childDescriptors) {
			String hint = behavDesc.model.diagram.part.ModelVisualIDRegistry.getType(next.getVisualID());
