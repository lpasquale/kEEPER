 ...
 * @generated
 */
public class ContextRelationTypeNamesEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContextRelationTypeNamesEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new contextRelation.model.diagram.edit.policies.ModelTextSelectionEditPolicy());
		...
		if (parser == null) {
			parser = contextRelation.model.diagram.providers.ModelParserProvider.getParser(
					...
					contextRelation.model.diagram.part.ModelVisualIDRegistry.getType(
							contextRelation.model.diagram.edit.parts.ContextRelationTypeNamesEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					contextRelation.model.diagram.edit.parts.ModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
