 ...
 * @generated
 */
public class ObserverNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Observer_2010, getParserElement(),
					ModelVisualIDRegistry
							.getType(typeinstance.model.diagram.edit.parts.ObserverNameEditPart.VISUAL_ID));
		}
		return parser;
	}
