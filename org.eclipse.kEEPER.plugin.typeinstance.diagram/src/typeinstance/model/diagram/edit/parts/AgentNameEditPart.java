...
public class AgentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider.getParser(ModelElementTypes.Agent_2009, getParserElement(),
					ModelVisualIDRegistry.getType(typeinstance.model.diagram.edit.parts.AgentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
