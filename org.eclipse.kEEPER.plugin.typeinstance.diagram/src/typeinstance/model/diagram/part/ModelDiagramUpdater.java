...
public class ModelDiagramUpdater {
	...
	*/
	 ...
	 * @generated
	 */
	public static List<ModelLinkDescriptor> getObserver_2010ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<ModelLinkDescriptor> getAgent_2009IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<ModelLinkDescriptor> getObserver_2010IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<ModelLinkDescriptor> getAgent_2009OutgoingLinks(View view) {
		return Collections.emptyList();
	}
