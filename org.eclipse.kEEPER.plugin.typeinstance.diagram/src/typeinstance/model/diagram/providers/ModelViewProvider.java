...
public class ModelViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return InstanceEditPart.VISUAL_ID == visualID || AgentEditPart.VISUAL_ID == visualID
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case TypeEditPart.VISUAL_ID:
			return createType_2012(domainElement, containerView, index, persisted, preferencesHint);
		}
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case InstanceTypeEditPart.VISUAL_ID:
			return createInstanceType_4003(containerView, index, persisted, preferencesHint);
		}
	...
	* @generated
	*/
	public Node createInstance_2005(EObject domainElement, View containerView, int index, boolean persisted,
	...
	* @generated
	*/
	public Node createType_2012(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label5015 = createLabel(node, ModelVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
		Node label5016 = createLabel(node, ModelVisualIDRegistry.getType(TypeNameEditPart.VISUAL_ID));
		return node;
	}
	...
	* @generated
	*/
	public Edge createInstanceType_4003(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(ModelVisualIDRegistry.getType(InstanceTypeEditPart.VISUAL_ID));
